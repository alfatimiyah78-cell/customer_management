        ...
        <div class="border-b border-zinc-200 border-b-zinc-300/80 dark:border-white/10 p-3">
            <div class="flex justify-between">
                <div class="flex justify-start">
                    <?php echo trans('roles.titles.permissions-card'); ?>
...
<?php $component->withAttributes(['size' => 'sm','variant' => 'pill','icon-trailing' => 'shield-exclamation']); ?>
                        <?php echo trans_choice('roles.cards.permissions-count', count($items), [
                        'count' => count($items),
                        ]); ?>
...
<?php $component->withAttributes([]); ?>
                            <div class="flex justify-start">
                                <strong class="text-blue-500"><?php echo e($item['permission']->name); ?></strong>
                            </div>
...
<?php $component->withAttributes(['class' => 'me-2','icon-trailing' => 'user-circle','size' => 'sm','variant' => 'pill']); ?>
                                    <?php echo trans_choice('roles.cards.users-count', count($item['users']), [
...
<?php endif; ?>
<?php $component->withAttributes(['size' => 'sm','variant' => 'pill','icon-trailing' => 'shield-exclamation']); ?>
                                    <?php echo trans_choice('roles.cards.roles-count', count($item['roles']), [
...
<?php $component->withAttributes([]); ?>
                                        <div class="mb-2">
                                            <div class="text-xs">
                                                <?php echo trans('roles.cards.permissions-card.permissions-table-roles-caption', [
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-px']); ?><?php echo trans('roles.cards.permissions-card.role-id'); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo trans('roles.cards.permissions-card.role-name'); ?>
...
<?php endif; ?>
                                                     ...
                                                     <?php $__env->slot('body', null, []); ?> 
                                                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $item['roles']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemUserKey => $itemRole): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.tables.cell','data' => ['class' => 'w-px']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-px']); ?>
                                                                <?php echo e($itemRole->id); ?>
...
<?php $component->withAttributes([]); ?>
                                        <div class="mb-2">
                                            <div class="text-xs">
                                                <?php echo trans('roles.cards.permissions-card.permissions-table-users-caption', [
                                                'permission' => $item['permission']->name,
                                                ]); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo trans('roles.cards.role-card.user-email'); ?>
...
<?php endif; ?>
                                                     <?php $__env->endSlot(); ?>
                                                     <?php $__env->slot('body', null, []); ?> 
                                                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $item['users']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemUserKey => $itemRole): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                        <?php if (isset($component)) { $__componentOriginal7dc152880c0620fc2a35c885f9303a4a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal7dc152880c0620fc2a35c885f9303a4a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.tables.row','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('tables.row'); ?>
...
<?php /**PATH C:\xampp\htdocs\customer_management\resources\views/livewire/admin/roles/cards/permissions-card.blade.php ENDPATH**/ ?>