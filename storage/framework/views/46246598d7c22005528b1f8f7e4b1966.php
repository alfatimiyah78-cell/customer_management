...
<div class="ml-1 grid flex-1 text-left text-sm">
    <span class="mb-0.5 truncate leading-none font-semibold"><?php echo e(config('app.name')); ?></span>
</div>
<?php /**PATH C:\xampp\htdocs\customer_management\resources\views/components/app-logo.blade.php ENDPATH**/ ?>