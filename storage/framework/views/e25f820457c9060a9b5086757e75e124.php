...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::navlist.item','data' => ['icon' => 'wifi','href' => route('managements.hotspots'),'wire:navigate' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'wifi','href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('managements.hotspots')),'wire:navigate' => true]); ?>
...
<?php /**PATH C:\xampp\htdocs\customer_management\resources\views/components/layouts/hotspot.blade.php ENDPATH**/ ?>