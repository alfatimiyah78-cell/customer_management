<div>
    <!--[if BLOCK]><![endif]--><?php if($disableCustomerModal): ?>
        <?php if (isset($component)) { $__componentOriginal8cc9d3143946b992b324617832699c5f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8cc9d3143946b992b324617832699c5f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::modal.index','data' => ['class' => 'md:w-120','wire:model' => 'disableCustomerModal','dismissible' => false,'@close' => '$dispatch(\'close-modal\')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'md:w-120','wire:model' => 'disableCustomerModal','dismissible' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'@close' => '$dispatch(\'close-modal\')']); ?>
            <div class="space-y-6">
                <div>
...
<?php $component->withAttributes(['size' => 'lg']); ?>
                        <?php echo e($user->disabled ? trans('customer.alert.header-enable-customer', ['customer' => $user->full_name]) : trans('customer.alert.header-disable-customer', ['customer' => $user->full_name])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::input.index','data' => ['wire:model' => 'input.current_password','label' => __('user.label.confirm-password'),'type' => 'password','name' => 'current_password','placeholder' => ''.e(__('Input your password')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'input.current_password','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('user.label.confirm-password')),'type' => 'password','name' => 'current_password','placeholder' => ''.e(__('Input your password')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['style' => 'cursor: pointer;','variant' => 'ghost','wire:click' => '$set(\'disableCustomerModal\', false)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['style' => 'cursor: pointer;','variant' => 'ghost','wire:click' => '$set(\'disableCustomerModal\', false)']); ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginalc04b147acd0e65cc1a77f86fb0e81580 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['type' => 'submit','variant' => ''.e($user->disabled ? 'success' : 'danger').'','icon' => 'power']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','variant' => ''.e($user->disabled ? 'success' : 'danger').'','icon' => 'power']); ?>
                            <?php echo e($user->disabled ? trans('customer.button.enable') : trans('customer.button.disable')); ?>
...
<?php /**PATH C:\xampp\htdocs\customer_management\resources\views/livewire/admin/customers/modal/disable-customer.blade.php ENDPATH**/ ?>