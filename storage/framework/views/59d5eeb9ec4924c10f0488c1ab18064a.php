<div>
    <!--[if BLOCK]><![endif]--><?php if($deleteCustomerModal): ?>
        <?php if (isset($component)) { $__componentOriginal8cc9d3143946b992b324617832699c5f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8cc9d3143946b992b324617832699c5f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::modal.index','data' => ['class' => 'md:w-120','wire:model' => 'deleteCustomerModal','dismissible' => false,'@close' => '$dispatch(\'close-modal\')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'md:w-120','wire:model' => 'deleteCustomerModal','dismissible' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'@close' => '$dispatch(\'close-modal\')']); ?>
            <div class="space-y-6">
                <div>
...
<?php $component->withAttributes(['size' => 'lg']); ?>
                        <?php echo e(trans('customer.alert.header-delete-customer', ['customer' => $user->full_name])); ?>
...
<?php $component->withAttributes(['class' => 'mt-2']); ?>
                        <?php echo trans('customer.alert.content-delete-customer', ['customer' => $user->first_name, 'count_paket' => count($user->customer_pakets)]); ?>
...
<?php endif; ?>
                ...
                <form wire:submit='deleteCustomer' class="flex flex-col gap-6">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['style' => 'cursor: pointer;','variant' => 'ghost','wire:click' => '$set(\'deleteCustomerModal\', false)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['style' => 'cursor: pointer;','variant' => 'ghost','wire:click' => '$set(\'deleteCustomerModal\', false)']); ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginalc04b147acd0e65cc1a77f86fb0e81580 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['type' => 'submit','variant' => 'danger','icon' => 'trash']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php $component->withAttributes(['type' => 'submit','variant' => 'danger','icon' => 'trash']); ?>
                            <?php echo e(trans('customer.button.delete')); ?>
...
<?php /**PATH C:\xampp\htdocs\customer_management\resources\views/livewire/admin/customers/modal/delete-customer.blade.php ENDPATH**/ ?>