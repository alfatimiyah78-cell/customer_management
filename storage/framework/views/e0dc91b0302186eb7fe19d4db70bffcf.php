<div>
    <!--[if BLOCK]><![endif]--><?php if($bulkDeleteCustomerModal): ?>
        <?php if (isset($component)) { $__componentOriginal8cc9d3143946b992b324617832699c5f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8cc9d3143946b992b324617832699c5f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::modal.index','data' => ['class' => 'md:w-120','wire:model' => 'bulkDeleteCustomerModal','dismissible' => false,'@close' => '$dispatch(\'close-modal\')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'md:w-120','wire:model' => 'bulkDeleteCustomerModal','dismissible' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'@close' => '$dispatch(\'close-modal\')']); ?>
            <div class="space-y-6">
                <div>
...
<?php $component->withAttributes(['size' => 'lg']); ?>
                        <?php echo e(trans('customer.alert.header-bulk-delete-customer', ['count' => $users->count()])); ?>
...
<?php $component->withAttributes(['class' => 'mt-2']); ?>
                        <?php echo trans('customer.alert.content-bulk-delete-customer', ['count' => $users->count()]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['style' => 'cursor: pointer;','variant' => 'ghost','wire:click' => '$set(\'bulkDeleteCustomerModal\', false)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['style' => 'cursor: pointer;','variant' => 'ghost','wire:click' => '$set(\'bulkDeleteCustomerModal\', false)']); ?>
...
<?php /**PATH C:\xampp\htdocs\customer_management\resources\views/livewire/admin/customers/modal/confirm-bulk-delete.blade.php ENDPATH**/ ?>