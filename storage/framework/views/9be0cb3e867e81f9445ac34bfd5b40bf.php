...
<?php endif; ?>
<?php $component->withAttributes(['size' => 'xl','level' => '1']); ?><?php echo e(__('system.title.payment-gateways')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::text','data' => ['size' => 'sm','class' => 'mb-6']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['size' => 'sm','class' => 'mb-6']); ?><?php echo __('system.sub-title.payment-gateways'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
[$__name, $__params] = $__split('admin.settings.payment-gateway.midtrans-form', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-2035296246-0', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('admin.settings.payment-gateway.tripay-form', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-2035296246-1', $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\xampp\htdocs\customer_management\resources\views/livewire/admin/settings/payment-gateway-management.blade.php ENDPATH**/ ?>