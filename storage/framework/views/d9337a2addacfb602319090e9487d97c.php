...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.auth-header','data' => ['title' => \App\Models\Websystem::first()->title ?? env('APP_NAME'),'description' => __('Enter your email and password below to log in')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\App\Models\Websystem::first()->title ?? env('APP_NAME')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Enter your email and password below to log in'))]); ?>
...
<?php /**PATH C:\xampp\htdocs\customer_management\resources\views/livewire/auth/login.blade.php ENDPATH**/ ?>