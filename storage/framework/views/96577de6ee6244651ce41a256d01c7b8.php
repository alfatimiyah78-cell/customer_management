...
<?php endif; ?>
<?php $component->withAttributes(['size' => 'xl','level' => '1']); ?><?php echo e($user->full_name); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::tooltip.index','data' => ['content' => ''.e(trans('customer.button.edit-customer')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['content' => ''.e(trans('customer.button.edit-customer')).'']); ?>
            <?php if (isset($component)) { $__componentOriginalc04b147acd0e65cc1a77f86fb0e81580 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc04b147acd0e65cc1a77f86fb0e81580 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['size' => 'sm','icon' => 'pencil','variant' => 'ghost','style' => 'cursor: pointer;','wire:click' => '$dispatch(\'edit-customer-modal\',{user: \''.e($user->username).'\'})']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['size' => 'sm','icon' => 'pencil','variant' => 'ghost','style' => 'cursor: pointer;','wire:click' => '$dispatch(\'edit-customer-modal\',{user: \''.e($user->username).'\'})']); ?>
...
<?php $component->withAttributes([]); ?>
        <?php echo e(trans('customer.label.address')); ?>: <?php echo e($user->user_address->address ?? '-'); ?>, <?php echo e($subdistrict['text'] ?? '-'); ?>, <?php echo e($district['text'] ?? '-'); ?>, <?php echo e($city['text'] ?? '-'); ?>, <?php echo e($province['text'] ?? '-'); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
        <?php echo e(trans('customer.label.email')); ?>: <?php echo e($user->email ?? '-'); ?>
...
<?php $component->withAttributes(['class' => 'mb-3']); ?>
        <?php echo e(trans('customer.label.phone')); ?>: <?php echo e($user->user_address->phone ?? '-'); ?>
...
<?php /**PATH C:\xampp\htdocs\customer_management\resources\views/partials/show-customer-heading.blade.php ENDPATH**/ ?>