...
<?php $component->withAttributes([]); ?>
                        <?php echo trans('roles.titles.roles-table'); ?>
...
<?php endif; ?>
            ...
            <div>
                <?php echo $__env->make('livewire.admin.roles.tables.role-items-table', [
                'tabletype' => $tableType,
                'items' => $tableItems,
...
[$__name, $__params] = $__split('admin.roles.modal.edit-role', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-2167090623-0', $__slots ?? [], get_defined_vars());
...
?>
<?php /**PATH C:\xampp\htdocs\customer_management\resources\views/livewire/admin/roles/tables/roles-table.blade.php ENDPATH**/ ?>