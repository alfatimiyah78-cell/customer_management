                                    ...
                                    <flux:button.group>
                                        ...
                                        <flux:button size="xs">
                                            <flux:checkbox wire:model.live="selectedCustomerPaket"
                                                wire:key="{{ $user->id }}" value="{{ $customer_paket->id }}" />
                                            <span
