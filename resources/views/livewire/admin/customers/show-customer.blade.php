<section class="w-full">
    ...
    <x-layouts.admin-customer.layout :heading="__('customer.customer-pakets')" :subheading="__('customer.pakets-description')" :user="$user">
        @php
            $deletedPakets = $user->customer_pakets()->onlyTrashed();
        @endphp
                        ...
                        <div class="grid gap-2">
                            ...
                            @if (
                                ...
                                <div class="grid md:grid-cols-2">
                                    ...
                                    <flux:text>
                                        <flux:button size="xs" iconTrailing="pencil" style="cursor: pointer;"
                            ...
                            <div class="grid md:grid-cols-2">
                                <flux:subheading>
                                    {{ trans('customer.label.last-bill') }}
                                </flux:subheading>
                                <flux:text>
                                    <flux:button size="xs" iconTrailing="pencil" style="cursor: pointer;" disabled
                                        wire:click="">
                                        {{ Carbon\Carbon::parse($customer_paket->last_billed_at)->format('d M Y') }}
                                    </flux:button>
                                </flux:text>
                            </div>
