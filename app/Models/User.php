...
class User extends Authenticatable
{
    ...
    protected static function boot()
    {
        ...
        static::restoring(function($user) {
           // $generalLogService = new GeneralLogServices;
            $user->user_address()->withTrashed()->restore();
            $user->user_customer()->withTrashed()->restore();
            $user->customer_pakets()->withTrashed()->restore();

            $user->customer_pakets()->withTrashed()->first()->customer_ppp_pakets()->withTrashed()->restore();
            $user->customer_pakets()->withTrashed()->first()->customer_static_pakets()->withTrashed()->restore();
            $user->customer_pakets()->withTrashed()->first()->customer_paket_addresses()->withTrashed()->restore();
            $user->customer_pakets()->withTrashed()->first()->invoices()->withTrashed()->restore();
           // $user->restoreCustomerPaket();
           // $user->ppp_pakets()->withTrashed()->restore();
           // $user->static_pakets()->withTrashed()->restore();
           // $user->customer_pakets()->withTrashed()->restore();
